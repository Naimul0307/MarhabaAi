                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($category->image) && file_exists(public_path('uploads/categories/thumb/small/'.$category->image)))
                                            <img src="{{ asset('uploads/categories/thumb/small/'.$category->image) }}" alt="image" width="50">
                                        @else
