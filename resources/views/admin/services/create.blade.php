...
/*
|--------------------------------------------------------------------------
| SERVICE LANGUAGE TAB
|--------------------------------------------------------------------------
|
| This is the important part.
|
| If user is on Arabic and validation fails,
| Arabic tab stays open.
|
|--------------------------------------------------------------------------
*/
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (
                ...
                /*
                |--------------------------------------------------------------------------
                | Sync the other language select
                |--------------------------------------------------------------------------
                */
