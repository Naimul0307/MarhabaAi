...
<head>
    ...
    @if (!empty($firstHeroImage))
        <link rel="preload" as="image" href="{{ asset('uploads/hero_slides/thumb/large/' . $firstHeroImage) }}" fetchpriority="high">
    @endif
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/subcategory.css') }}">
